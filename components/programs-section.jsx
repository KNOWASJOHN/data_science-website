        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="hover:shadow-xl transition-all duration-300 hover:scale-105 hover-lift flex flex-col h-full">
            ...
            <CardContent className="flex flex-col flex-grow">
              ...
              <Button className="w-full bg-cyan-600 hover:bg-cyan-700 mt-auto">Learn More</Button>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-xl transition-all duration-300 hover:scale-105 hover-lift flex flex-col h-full">
            ...
            <CardContent className="flex flex-col flex-grow">
              ...
              <Button className="w-full bg-cyan-600 hover:bg-cyan-700 mt-auto">Explore Research</Button>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-xl transition-all duration-300 hover:scale-105 hover-lift flex flex-col h-full">
            ...
            <CardContent className="flex flex-col flex-grow">
              ...
              <Button className="w-full bg-cyan-600 hover:bg-cyan-700 mt-auto">View Opportunities</Button>
            </CardContent>
          </Card>
        </div>
      </div>
